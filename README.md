...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/withered-sky-a5de#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/withered-sky-a5de
```

A live public deployment of this template is available at [https://withered-sky-a5de.templates.workers.dev](https://withered-sky-a5de.templates.workers.dev)
